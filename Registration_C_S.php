...
<!--
			...
			<div class="col-md-2"></div>
					...
					<form method="post" onsubmit="return false">
                        ...
                        <div class="row">
							<div class="col-md-12">
								<label for="cnic">Aadhar No</label>
								<input type="text" id="cnic" name="cnic"class="form-control" oninput="formatInput()">
							</div>
						</div>
                        <hr>
                        <div >
...
function formatInput() {
  // Get the input value
  var inputValue = document.getElementById("cnic").value;

  // Remove any existing hyphens and whitespaces from the input value
  inputValue = inputValue.replace(/-/g, '').replace(/ /g, '');

  // Insert hyphen after every four digits
  var formattedValue = inputValue.replace(/\d{4}(?!$)/g, '$&-');

  // Update the input value with the formatted value
  document.getElementById("cnic").value = formattedValue;
}
</script>
