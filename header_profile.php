...
$data = "SELECT * FROM orders where user_id = '$id_c' and payment_status='cash_on_delivery' and order_status='process_order' or order_status='complete'  ";
    ...
    ?>
                                            ...
                                            <span class="cart_count"><?php echo  $ct_p; ?></span>
                                            
                                            <span class="cart_price">₹ <?php echo $a; ?> <i class="ion-ios-arrow-down"><a class="active" href="Customer_cart.php">View Cart</a></i></span>
                                        ...
                                        <div class="mini_cart">
                                            <div class="mini_cart_inner">
                                                ...
                                                <div class="cart_total">
                                                        <span>Sub Total:</span>
                                                        <span class="price">₹ <?php echo $a;  ?></span>
                                                    </div>
